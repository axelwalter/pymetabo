...
FeatureLinker.run(os.path.join(interim, "FFM_aligned"), os.path.join(interim,  "FFM.consensusXML"))
...
MapAligner.run(mzML_dir, os.path.join(interim, "MzML_aligned"), os.path.join(interim, "Trafo"))
...
FeatureFinderMetaboIdent.run(os.path.join(interim, "MzML_aligned"), os.path.join(interim, "FFMID"), library)

FeatureMapHelper.merge_feature_maps(os.path.join(interim, "FeatureMaps_merged"), os.path.join(interim, "FFM_complete"), os.path.join(interim, "FFMID"))
...
MapID.run(os.path.join(interim, "MzML_aligned"), os.path.join(interim, "FeatureMaps_decharged"), os.path.join(interim, "FeatureMaps_ID_mapped"))

FeatureLinker.run(os.path.join(interim, "FeatureMaps_merged"), os.path.join(interim, "FeatureMatrix.consensusXML"))

DataFrames.create_consensus_table(os.path.join(interim, "FeatureMatrix.consensusXML"), os.path.join(results, "FeatureMatrix.tsv"))
